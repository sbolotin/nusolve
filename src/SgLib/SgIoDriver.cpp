...
//
SgIoDriver::SgIoDriver(const SgIdentities* ids, const SgVersion* dv)
  : dateOfCreation_(tZero)
{
  currentIdentities_ = ids; 
  currentDriverVersion_ = dv;
  inputIdentities_ = NULL; 
