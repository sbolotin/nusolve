...
#ifndef NS_TEST_FOUR1_DIALOG_H
#define NS_TEST_FOUR1_DIALOG_H
...
/*=====================================================================================================*/
class NsTestFour1Dialog : public QDialog
{
  Q_OBJECT
public:
  ...
  // Functions:
  //
  inline QString className() const {return "NsTestFour1Dialog";};
